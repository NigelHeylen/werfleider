...
public class SparseArrayTypeAdapter<T> extends TypeAdapter<SparseArray<T>> {
  ...
  @Override public void write(JsonWriter jsonWriter, SparseArray<T> tSparseArray)
      throws IOException {
  ...
  @Override public SparseArray<T> read(JsonReader jsonReader) throws IOException {
